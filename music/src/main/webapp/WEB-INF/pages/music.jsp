                  ...
                  <div class="row m-t-lg m-b-lg">
                    <div class="col-sm-6">
                      <div class="bg-primary wrapper-md r">
                        <a href="#">
                          <span class="h4 m-b-xs block"><i class=" icon-user-follow i-lg"></i>注册用户</span>
                          <span class="text-muted">注册用户来听取天籁之音~~~</span>
                        </a>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="bg-black wrapper-md r">
                        <a href="#">
                          <span class="h4 m-b-xs block"><i class="icon-cloud-download i-lg"></i>相关信息</span>
                          <span class="text-muted">本网站由突破天际小组制作,如有雷同,纯属巧合</span>
                        </a>
                      </div>
                    </div>
                  </div>
